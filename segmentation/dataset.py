...
def main(config):
    ...
    for filename in filenames:
        ...
        if ext =='.jpg':
            ...
            data_list.append('TAO_'+filename+'.jpg')
            GT_list.append('TAO_'+filename+'_segmentation.png')
...
if __name__ == '__main__':
    ...
    # data path
    parser.add_argument('--origin_data_path', type=str, default='../TAO/dataset/')
    parser.add_argument('--origin_GT_path', type=str, default='../TAO/dataset/')
